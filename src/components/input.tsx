...
export const Input = ({ id, type, label, register, error }: inputProps) => {
    ...
    return (<div className="flex flex-col items-start justify-center relative mb-4">
        ...
        <input {...register} id={id} type={type === "password" && seePassword ? "text" : type} className={`border-1 border-gray-200 rounded-md w-full py-2 px-4 focus:outline-none focus:border-gray-950 `} />
